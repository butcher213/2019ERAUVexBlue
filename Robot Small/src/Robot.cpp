...
const int Robot::ARM_RAISED = 100; // TODO make sure that the fully raised arm is this number
...
// Arm motor
//**********
RampingMotor Robot::armRight = RampingMotor(ARM_RIGHT_PORT,
                                            pros::E_MOTOR_GEARSET_18,
                                            true,
                                            DRIVE_RAMP_SCALE);
RampingMotor Robot::armLeft  = RampingMotor(ARM_LEFT_PORT,
                                            pros::E_MOTOR_GEARSET_18,
                                            false,
                                            DRIVE_RAMP_SCALE);
...
// Intake motor
//*************
RampingMotor Robot::intakeLeft  = RampingMotor(INTAKE_LEFT_PORT,
                                               pros::E_MOTOR_GEARSET_18,
                                               false,
                                               DRIVE_RAMP_SCALE);
RampingMotor Robot::intakeRight = RampingMotor(INTAKE_RIGHT_PORT,
                                               pros::E_MOTOR_GEARSET_18,
                                               true,
                                               DRIVE_RAMP_SCALE);
